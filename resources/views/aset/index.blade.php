             ...
             <section class="content">
              <div class="box">
               <div class="box-header">
                <div class="row">
                  <div class="col-sm-9">
                    <h4 class="box-title">Daftar Aset</h4>
                  </div>
                    <div class="col-sm-3">
                      <a class="btn btn-primary" href="{{ url('/asetcreate')}}">Tambah Aset Baru</a>
                     </div>
                    </div>
                  </div>
                </div>
      ...
      <div class="card-body">
        ...
        <form method="POST" action="#">
         ...
         @component('layouts.search', ['title' => 'Cari'])
          @component('layouts.two-cols-search-row', ['items' => ['Aset'], 
        ...
        <div class="row">
          <div class="col-sm-12">
            <table id="example2" class="table table-bordered table-hover dataTable dtr-inline" role="grid" aria-describedby="example2_info">
                ...
                <?php
                  $result = file_get_contents("http://localhost:8080/aset/aset/{id}/load");
 ...
 $.each(bData,function(_,obj) {
    ...
    var btndelete= '<a class="btn btn-danger" href="{{ url('/golcreate')}}">Delete</a>';
      tr = $("<tr />"); 
        ...
        tr.append("<td>"+obj.id_kondisi+"</td>")
