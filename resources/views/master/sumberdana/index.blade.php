             ...
             <section class="content">
              <div class="box">
               <div class="box-header">
                <div class="row">
                  <div class="col-sm-9">
                    <h4 class="box-title">Daftar Sumber Dana</h2>
                  </div>
                    <div class="col-sm-3">
                      <a class="btn btn-primary" href="{{ url('/sdcreate')}}">Tambah Sumber Dana Baru</a>
                     </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="col-sm-12">
            <table id="example2" class="table table-bordered table-hover dataTable dtr-inline" role="grid" aria-describedby="example2_info">
                ...
                <tr role="row">
                  ...
                  <th class="sorting_desc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" aria-sort="descending">Kode Sumber Dana</th>
                  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Nama Sumber Dana</th>
               ...
               <?php
                  $result = file_get_contents("http://localhost:8080/aset/sumberdana");
