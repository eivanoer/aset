             ...
             <section class="content">
              <div class="box">
               <div class="box-header">
                <div class="row">
                  <div class="col-sm-9">
                    <h4 class="box-title">Daftar Lokasi</h4>
                  </div>
                    <div class="col-sm-3">
                      <a class="btn btn-primary" href="{{ url('/lokasicreate')}}">Tambah Lokasi Baru</a>
                     </div>
                    </div>
                  </div>
                </div>
      ...
      <div class="card-body">
        ...
        <form method="POST" action="#">
         ...
         @component('layouts.search', ['title' => 'Cari'])
          @component('layouts.two-cols-search-row', ['items' => ['Lokasi'], 
          ...
          <div class="col-sm-12">
            <table id="example2" class="table table-bordered table-hover dataTable dtr-inline" role="grid" aria-describedby="example2_info">
                ...
                <tr role="row">
                  ...
                  <th class="sorting_desc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" aria-sort="descending">Nama Lokasi</th>
                  ...
                  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Longitude</th>
                ...
                <?php
                  $result = file_get_contents("http://localhost:8080/aset/lokasi");
...
var tbody = $("<tbody />"),tr;
 $.each(bData,function(_,obj) {
    pno = pno+1;
    var kode=obj.id;
    var btn= '<a class="btn btn-warning" href="{{ url('/lokasiedit/')}}'+'/'+kode+'">Edit</a>';
    var btndelete= '<a class="btn btn-danger" href="{{ url('/golcreate')}}">Delete</a>';
      tr = $("<tr />"); 
        tr.append("<td>"+pno+"</td>")
        tr.append("<td>"+obj.nama+"</td>")
        tr.append("<td>"+obj.alamat+"</td>") 
        tr.append("<td>"+obj.longitude+"</td>") 
        tr.append("<td>"+obj.latitude+"</td>") 
