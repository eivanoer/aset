             ...
             <section class="content">
              <div class="box">
               <div class="box-header">
                <div class="row">
                  <div class="col-sm-9">
                    <h4 class="box-title">Daftar Satuan</h4>
                  </div>
                    <div class="col-sm-3">
                      <a class="btn btn-primary" href="{{ url('/satuancreate')}}">Tambah Satuan Baru</a>
                     </div>
                    </div>
                  </div>
                </div>
      ...
      <div class="card-body">
        ...
        <form method="POST" action="#">
         ...
         @component('layouts.search', ['title' => 'Cari'])
          @component('layouts.two-cols-search-row', ['items' => ['Satuan'], 
          ...
          <div class="col-sm-12">
            <table id="example2" class="table table-bordered table-hover dataTable dtr-inline" role="grid" aria-describedby="example2_info">
                ...
                <tr role="row">
                  ...
                  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Nama Satuan</th>
               ...
               <?php
                  $result = file_get_contents("http://localhost:8080/aset/satuan");
...
var tbody = $("<tbody />"),tr;
 $.each(bData,function(_,obj) {
    pno = pno+1;
    var kode=obj.id;
    var btn= '<a class="btn btn-warning" href="{{ url('/satuanedit/')}}'+'/'+kode+'">Edit</a>';
