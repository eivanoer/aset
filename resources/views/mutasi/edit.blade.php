...
document.getElementById("txtaset").value =bData.nama;
document.getElementById("txtgolongan").value =bData.alamat;
document.getElementById("txtmasa").value =bData.longitude;
document.getElementById("txttarif").value =bData.latitude;
