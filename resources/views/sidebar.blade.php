    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ url('/penyusutan')}}" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Penyusutan
              </p>
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ url('/kodeperkiraan')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Kode Perkiraan</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ url('/subperkiraan')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Sub Perkiraan</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ url('/kondisi')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Kondisi</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="{{ url('/sumberdana')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Sumber Dana</p>
                </a>
              </li>
