@include('manajemenaset.asettanah.base')
             ...
             <section class="content">
              <div class="box">
               <div class="box-header">
                <div class="row">
                  <div class="col-sm-9">
                    <h4 class="box-title">Daftar Aset Tanah</h4>
                  </div>
                    <div class="col-sm-3">
                      <a class="btn btn-primary" href="{{ url('/asetcreate')}}">Tambah Aset Tanah Baru</a>
                     </div>
                    </div>
                  </div>
                </div>
      ...
      <div class="card-body">
        ...
        <form method="POST" action="#">
         ...
         @component('layouts.search', ['title' => 'Cari'])
          @component('layouts.two-cols-search-row', ['items' => ['Aset Tanah'], 
          ...
          <div class="col-sm-12">
            <table id="example2" class="table table-bordered table-hover dataTable dtr-inline" role="grid" aria-describedby="example2_info">
                ...
                <tr role="row">
                  ...
                  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Satuan</th>
                  ...
                  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Harga Perolehan</th>
                  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Tahun</th>
                  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Sumber Dana</th>
                  ...
                  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Lokasi</th>
                ...
                <?php
                  $result = file_get_contents("http://localhost:8080/aset/asettanah/{id}/load");
...
var tbody = $("<tbody />"),tr;
 $.each(bData,function(_,obj) {
    ...
    var btndelete= '<a class="btn btn-danger" href="{{ url('/golcreate')}}">Delete</a>';
      tr = $("<tr />"); 
        tr.append("<td>"+pno+"</td>")
        tr.append("<td>"+obj.kode+"</td>")
        tr.append("<td>"+obj.nama+"</td>") 
        tr.append("<td>"+obj.id_satuan+"</td>") 
        tr.append("<td>"+obj.volume+"</td>") 
        tr.append("<td>"+obj.harga_perolehan+"</td>")
        tr.append("<td>"+obj.tahun_perolehan+"</td>")
        tr.append("<td>"+obj.id_sumberdana+"</td>")
        tr.append("<td>"+obj.id_status+"</td>")
        tr.append("<td>"+obj.keterangan+"</td>")
        tr.append("<td>"+obj.lokasi+"</td>")
